...
namespace SistemaVendasWeb.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Funcionario f1 = new Funcionario(1, "Raul Gil", "raul@gmail.com", "111", "81888888", "111", "SDS", 'M', "raul", "123", e1, s1, i1, new DateTime(1999, 05, 01), new DateTime(2021, 05, 21), new DateTime(), new DateTime(), "1111111");
            Funcionario f2 = new Funcionario(2, "Carlos Alberto", "carlos@gmail.com", "222", "8122222", "222", "SDS", 'M', "carlos", "123", e2, s2, i1, new DateTime(1899, 12, 03), new DateTime(2021, 05, 21), new DateTime(), new DateTime(), "444444");
            Funcionario f3 = new Funcionario(3, "Maria Lurdes", "maria@gmail.com", "222", "21333333", "333", "SDS", 'F', "maria", "123", e3, s3, i1, new DateTime(2000, 07, 21), new DateTime(2021, 05, 21), new DateTime(), new DateTime(), "555555");
